// PanelWrapper for height stretching
...
const ResponseDetails = ({ apiResponse }) => {
  ...
  const titleColor = getRiskColor(resultMessage);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="bg-gradient-to-b from-slate-800/90 to-slate-900/90 rounded-2xl shadow-xl px-8 py-6 flex flex-col items-center mb-2 w-full max-w-md">
          <div className="mb-2">
      ...
      {/* First Row: AI Model Results + Suspicious Attributes */}
      ...
      {/* Second Row: Attribute Scores + Derived Attributes */}
